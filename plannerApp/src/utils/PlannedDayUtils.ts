...
import { DayKeyUtils } from "./DayKeyUtils";

export class PlannedDayUtility {
    private static TimeOfDayKeys = {
        "Morgen": ["06:00", "08:59"],
    ...
    public static getTimeOfDayKey(startDate: Date, endDate: Date) {
        ...
        for(const [timeOfDayKey, hours] of Object.entries(this.TimeOfDayKeys)) {
